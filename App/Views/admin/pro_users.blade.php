...
@section('content')
    ...
    <section class="main">
        ...
        <div>
            <ul class="list-group">
                <li class="list-group-item">Total no. of pro members: {{$pct}}</li>
        ...
        <div id="user_type_div">
            ...
            <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" id="paid" name="user_type" value="unpaid" class="custom-control-input user-type" required>
                <label class="custom-control-label" for="paid">Unpaid Pro-Members</label>
            </div>
        </div>
