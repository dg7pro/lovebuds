            ...
            <div class="col-lg-12">
                <div class="card card-default">
                    <div class="card-header bg-info card-header-border-bottom">
                        <h2>Needs KYC Documents approval</h2>
                    </div>
                    <div class="card-body">
                        <p class="mb-5">These users need KYC documents approval.
                            <span class="badge badge-secondary text-wrap">(Instruction: match the name with the name on kyc docs and approve if correct)</span></p>
...
@section('app-script')
    ...
    <script>
        ...
        function readKYCDocsRecords() {
            ...
            $.ajax({
                url: "/adjax/getUnApprovedKycDocs",
                type: "POST",
                data: {
