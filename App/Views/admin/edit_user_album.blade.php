...
@section('content')
    ...
    <section class="profile">
        ...
        <div class="album-card mt-5">
            ...
            <h3 class="album-heading text-blue">{{$user->first_name.'\'s Upload Page:'}}</h3>
        ...
        <div class="album-card mb-5">
           ...
           {{-- <div>
            ...
            <div class="mt-4">
                <a href="{{'/admin/adjust-user-album?id='.$user->id}}" class="btn btn-sm btn-yellow">Adjust Images <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
