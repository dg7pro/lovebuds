...
@section('content')
    ...
    <section class="main">
        ...
        <p class="lead"><i class="fas fa-user text-blue"> </i> All Members are bound by following terms & conditions</p>

        <p class="mb-2"> The terms "We" / "Us" / "Our"/”Company” individually and collectively refer
            to JU Matrimony Service and the terms "Visitor” ”User” refer to the users.</p>
