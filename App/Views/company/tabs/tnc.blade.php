<div class="tab-pane pt-3 fade show active" id="terms" role="tabpanel" aria-labelledby="privacy-tab">

    <h3 class="mt-3 mb-2">Terms & Conditions </h3>

    <p class="mb-2"> The terms "We" / "Us" / "Our"/”Company” individually and collectively refer
        to Just Unite Foundation and the terms "Visitor” ”User” refer to the users.</p>
